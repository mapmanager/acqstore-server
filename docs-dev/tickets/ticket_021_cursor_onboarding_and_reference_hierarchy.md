...
- Rewrites `docs-dev/README.md` as a short landing page.
- Rewrites `docs-dev/client-roadmap.md` as a self-sufficient first-client workflow.
- Moves active detailed API v2 documents to `docs-dev/reference/`.
