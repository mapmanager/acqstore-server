...
- Copied legacy v1 documents into `docs-dev/v1/` with stable names.
...
```bash
rm docs-dev/entry_point_and_packaging.md \
   docs-dev/html_integration_v0.md \
   docs-dev/llm_agent_guide_v0.md \
   docs-dev/reference_api_v0.md \
   docs-dev/roadmap.md
```

Their full contents are preserved under `docs-dev/v1/`.
