...
- Opened a local sample OIR path visible to the server (machine-specific absolute path redacted)
...
- `docs-dev/v2/api.md` — exact endpoints, JSON shapes, binary
  media type, byteLength/sample-count validation rules, session delete contract,
  stable error envelope
- `docs-dev/v2/javascript-client.md` — complete reusable
...
2. `docs-dev/client-roadmap.md`

Then, because the roadmap was insufficient to implement steps 4–7, opened:

3. `docs-dev/v2/api.md`
4. `docs-dev/v2/javascript-client.md`
